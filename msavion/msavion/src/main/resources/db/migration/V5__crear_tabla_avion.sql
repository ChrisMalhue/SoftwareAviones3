...
INSERT INTO aviones (matricula, marca, modelo, ID_tipo, capacidad_pasajero, envergadura_metros, capacidad_combustible, ID_fabricante, ID_origen) VALUES
('CC-ABC', 'Boeing', '737-800', 1, 160, 35.8, 26020.0, 1, 1);

INSERT INTO aviones (matricula, marca, modelo, ID_tipo, capacidad_carga_kg, envergadura_metros, capacidad_combustible, ID_fabricante, ID_origen) VALUES
('CC-CGO', 'Airbus', 'A300-600F', 2, 57600.0, 44.8, 62000.0, 2, 2);